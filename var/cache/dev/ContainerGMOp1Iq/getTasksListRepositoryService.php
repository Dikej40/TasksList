...
// Returns the private 'App\Repository\TasksListRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\TasksListRepository.php';

return $this->privates['App\Repository\TasksListRepository'] = new \App\Repository\TasksListRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
